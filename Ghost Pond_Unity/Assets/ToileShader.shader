...
////// Emissive:
                ...
                float2 node_4469 = (i.uv0+float2((cos(node_1615)*_DistortWater*node_4842),(sin(node_1615)*_DistortWater*node_4842)));
                float4 _Render_var = tex2D(_Render,TRANSFORM_TEX(node_4469, _Render));
